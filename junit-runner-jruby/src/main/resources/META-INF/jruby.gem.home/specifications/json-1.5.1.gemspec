...
Gem::Specification.new do |s|
  ...
  s.files = ["./tests/test_json_encoding.rb", "./tests/test_json_addition.rb", "./tests/test_json.rb", "./tests/test_json_string_matching.rb", "./tests/test_json_generate.rb", "./tests/test_json_unicode.rb", "./tests/test_json_fixtures.rb", "bin/edit_json.rb", "bin/prettify_json.rb", "ext/json/ext/generator/extconf.rb", "ext/json/ext/parser/extconf.rb"]
