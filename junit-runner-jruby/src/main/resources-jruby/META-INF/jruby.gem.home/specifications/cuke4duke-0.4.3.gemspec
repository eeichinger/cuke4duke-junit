...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<celerity>, [">= 0.8.7"])
      s.add_development_dependency(%q<jruby-openssl>, [">= 0.7.2"])
      s.add_development_dependency(%q<bundler>, [">= 1.0.7"])
      s.add_development_dependency(%q<rake>, [">= 0.8.7"])
    else
      s.add_dependency(%q<cucumber>, ["~> 0.10.0"])
      s.add_dependency(%q<rspec>, [">= 2.3.0"])
      s.add_dependency(%q<celerity>, [">= 0.8.7"])
      s.add_dependency(%q<jruby-openssl>, [">= 0.7.2"])
